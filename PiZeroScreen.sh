...
sudo apt install git mc fail2ban python-rpi.gpio python-spidev python-pip python-pil python-numpy python3 python3-rpi.gpio python3-spidev python3-pip python3-pil python3-numpy --no-install-recommends
